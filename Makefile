...
export TERRAFORM_PROVIDER_SOURCE ?= ansible/aap
export TERRAFORM_PROVIDER_REPO ?= https://github.com/ansible/terraform-provider-aap
export TERRAFORM_PROVIDER_VERSION ?= 1.4.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-aap
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/ansible/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-aap_v1.40
...
xpkg.build.provider-aap: do.build.images
