module github.com/crossplane-contrib/provider-aap
...
require (
	...
	github.com/ansible/terraform-provider-aap v1.4.0
...
replace github.com/ansible/terraform-provider-aap v1.4.0 => ../../ansible/terraform-provider-aap
