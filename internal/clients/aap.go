...
import (
	...
	clusterv1beta1 "github.com/crossplane-contrib/provider-aap/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/crossplane-contrib/provider-aap/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal aap credentials as JSON"
	keyToken                = "token"
